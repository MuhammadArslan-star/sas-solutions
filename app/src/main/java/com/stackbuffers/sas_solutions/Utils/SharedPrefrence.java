...
import com.stackbuffers.sas_solutions.Model.User.UserModel;
...
public class SharedPrefrence {
    ...
    public static String OLD_FIREBASE_TOKEN="OLD_FIREBASE_TOKEN";
    public static String ShowPopAds="ShowPopAds";
    public static String adsImage="adsImage";
    ...
    public void setParentUser(UserModel modelSignUp) {
